...
make test_file_block FILE=MigrationToolETH BLOCK=23134281;
make test_file_block FILE=MigrationToolUSD BLOCK=23134281;
...
make test_file_block_optimism FILE=MigrationToolETHOptimism BLOCK=139985371;