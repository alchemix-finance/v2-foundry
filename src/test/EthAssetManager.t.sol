...
import { EthAssetManager, MetaPoolAsset, SLIPPAGE_PRECISION, CURVE_PRECISION, InitializationParams as ManagerInitializationParams } from "../EthAssetManager.sol";
...
contract EthAssetManagerTest is DSTestPlus, stdCheats {
	...
	function testReclaimETH() external {
		...
		hevm.expectCall(
			...
			abi.encodeWithSelector(IERC20TokenReceiver.onERC20Received.selector, address(weth), 2e18)
		);
