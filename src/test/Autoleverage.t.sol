...
contract AutoleverageTest is DSTestPlus, stdCheats {
	...
	function testFlashLoanMetapool() public {
		...
		IAlchemistV2.YieldTokenParams memory prevYieldTokenParams = IAlchemistV2(alchemist).getYieldTokenParameters(
			yieldToken
		);
		...
		IAlchemistV2.YieldTokenParams memory yieldTokenParams = IAlchemistV2(alchemist).getYieldTokenParameters(
			yieldToken
		);
