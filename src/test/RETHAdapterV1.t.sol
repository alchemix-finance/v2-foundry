...
import { RETHAdapterV1, InitializationParams as AdapterInitializationParams } from "../adapters/rocket/RETHAdapterV1.sol";
...
contract RocketStakedEthereumAdapterV1Test is DSTestPlus, stdCheats {
  ...
  function setUp() external {
    ...
    adapter = new RETHAdapterV1(
      AdapterInitializationParams({ alchemist: address(this), token: address(rETH), underlyingToken: address(weth) })
    );
  }
