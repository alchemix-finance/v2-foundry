...
interface IAlchemistV2Errors {
    /// @notice An error which is used to indicate that an operation failed because it tried to
    ///         operate on a token that the system did not recognize.
    ///
    /// @param token The address of the token.
    error UnsupportedToken(address token);

    /// @notice An error which is used to indicate that an operation failed because it tried to
    ///         operate on a token that has been disabled.
    ///
    /// @param token The address of the token.
    error TokenDisabled(address token);

    /// @notice An error which is used to indicate that an operation failed because an account
    ///         became undercollateralized.
    error Undercollateralized();

    /// @notice An error which is used to indicate that an operation failed because the expected
    ///         value of a yield token in the system exceeds the maximum value permitted.
    ///
    ...
    /// @notice An error which is used to indicate that an operation failed because the loss that a
    ///         yield token in the system exceeds the maximum value permitted.
    ///
    /// @param yieldToken  The address of the yield token.
    ...
    /// @notice An error which is used to indicate that a minting operation failed because the
    ///         minting limit has been exceeded.
    ///
    ...
    /// @notice An error which is used to indicate that an repay operation failed because the repay
    ///         limit for an underlying token has been exceeded.
    ///
    ...
    /// @notice An error which is used to indicate that an repay operation failed because the
    ///         liquidation limit for an underlying token has been exceeded.
    ///
    /// @param underlyingToken The address of the underlying token.
    ...
    /// @notice An error which is used to indicate that the slippage of a wrap or unwrap operation
    ///         was exceeded.
    ///
    /// @param amount           The amount of underlying or yield tokens returned by the operation.
    /// @param minimumAmountOut The minimum amount of the underlying or yield token that was
    ///                         expected when performing the operation.
