            ...
            if (h.reward == vspRewardToken) {
              ...
              if (h.alchemist == usdAlchemistAddress) {
                if (h.yieldToken == vaDAI) {
                  ...
                  expectedExchange = _getExpectedExchange(uniswapFactoryAddress, h.reward, wethAddress, uint24(3000), dai, uint24(3000), amounts[0]);
              ...
              // alETH route for vesper swap
                ...
                expectedExchange = _getExpectedExchange(uniswapFactoryAddress, h.reward, wethAddress, uint24(3000), address(0), uint24(0), amounts[0]);
              }
              return (
                true,
